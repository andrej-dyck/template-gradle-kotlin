# Multi-module Kotlin Project using Gradle Groovy

**NOTE**: This template is archived (worked with Java 8+9). 

### Specifics

* This template ([build.gradle], [settings.gradle]) is for multi-module projects and uses Groovy script.
* Gradle sub-project build files have custom names ("{project-name}.gradle")
...
* Example Kotlin sub-projects ([domain-module/domain-module.gradle], [details-module/details-module.gradle], [main/main.gradle])
  ...
  * [details-module/details-module.gradle] depicts how to use dependencies from [gradle/dependencies.gradle] or predefined as single gradle file (e.g., [gradle/log4j.gradle])
